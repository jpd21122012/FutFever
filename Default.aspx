<%@ Page Title="Soccer Club" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SoccerWebApp._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class=banner id=layerSlider style="width: 100%;">
        <div class=ls-slide data-ls="transition3d: 33,15; slidedelay: 8000 ; durationin:0;"><img
                src=Assets/images/banner/background01.jpg class=ls-bg alt="Slide background">
            ...
            <div class="ls-l layercontent01" style="top: 50%; left: 50%; z-index:4;"
                 data-ls="offsetxin:left; offsetxout:right; durationin: 4000; parallaxlevel: 8;"><img
                    src=Assets/images/banner/player.png alt=innerimage class=img-responsive
                    style="max-width: 100% !important ;"></div>
            <img src=Assets/images/banner/ball.png alt=innerimage class="ls-l layercontent02" style=z-index:5;
                 data-ls="offsetxin: right; offsetxout:left; rotatein:-360; easingin: easeoutquart; durationin: 4000; delayin: 250; parallaxlevel: -5;">
            <img src=Assets/images/banner/front_particles.png alt=particles class=ls-l style="z-index:3; left:0;"
                 data-ls="offsetxin: left; offsetxout:left; scalexin:50; easingin: easeoutquart; durationin: 3000; delayin: 250;">
            <img src=Assets/images/banner/back_particles.png alt=particles class=ls-l style="z-index:3; left:50%;"
            ...
            <div class=row><h2 class=heading>latest <span>result</span></h2>
                ...
                <div class="result clearfix">
                    <div class=result-details>
                        ...
                        <div class=figure>
                            <div class=team-logo>
                                <div style=background:url(Assets/images/team-logo/logo01.png) class=teamLogoImg></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=result-details>
                        ...
                        <div class="figure figresult">
                            <div class=team-logo>
                                <div style=background:url(Assets/images/team-logo/logo02.png) class=teamLogoImg></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-blackimg match_versus02">
                            <div class=nextmatchDetails><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                ...
                                <div class="wrap-logo clearfix">
                                    <div class=logo-match><img src=Assets/images/matchResult/logo01.png alt=image></div>
                                    <div class=match_vs>vs</div>
                                    <div class=logo-match><img src=Assets/images/matchResult/logo02.png alt=image></div>
                                </div>
                    ...
                    <div class="tab-content news_display_container clearfix">
                        <ul id=world_news class=tab-pane>
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/w_news_01.jpg alt=image></div>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/w_news-02.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/w_news-03.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/w-news-04.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                        ...
                        <ul id=club_news class="tab-pane active clearfix">
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/c_news_01.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/c_news_02.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/c_news_03.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/c_news_04.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                            ...
                            <li>
                                <div class=figure>
                                    <div class=column-news>
                                        <div class=figure-01><img src=Assets/images/news/c_news_05.jpg alt=image></div>
                                        <div class=content-01><h6><a href=#>consectetur adipisicing elit</a></h6>
                ...
                <div class="wrapplayer clearfix"><a class="prv prev-player"></a> <a class="nxt next-player"></a>
                    <ul class="slideHeroes clearfix">
                        <li><a href="#">
                            <div class=playerFig>
                                <div class=playerpic>
                                    <div style=background:url(Assets/images/player/player01.jpg) class=bgimg></div>
                                </div>
                                <ul class="playerDetails clearfix">
                                    <li><span>Daren Difiore</span> <span><img src=Assets/images/icons/tShirt.png
                                                                              alt=image></span></li>
                        ...
                        <li><a href="#">
                            <div class=playerFig>
                                <div class=playerpic>
                                    <div style=background:url(Assets/images/player/player02.jpg) class=bgimg></div>
                                </div>
                                <ul class="playerDetails clearfix">
                                    <li><span>Terry Tijerina</span> <span><img src=Assets/images/icons/tShirt.png
                                                                               alt=image></span></li>
                                    <li class=playinfodetails>age 28 (born 22 april ,1987)</li>
                        ...
                        <li><a href="#">
                            <div class=playerFig>
                                <div class=playerpic>
                                    <div style=background:url(Assets/images/player/player03.jpg) class=bgimg></div>
                                </div>
                                <ul class="playerDetails clearfix">
                                    <li><span>Alex Alameda</span> <span><img src=Assets/images/icons/tShirt.png
                                                                             alt=image></span></li>
                                    <li class=playinfodetails>age 28 (born 22 april ,1987)</li>
                        ...
                        <li><a href="#">
                            <div class=playerFig>
                                <div class=playerpic>
                                    <div style=background:url(Assets/images/player/player04.jpg) class=bgimg></div>
                                </div>
                                <ul class="playerDetails clearfix">
                                    <li><span>Lane Lavalley</span> <span><img src=Assets/images/icons/tShirt.png
                                                                              alt=image></span></li>
                                    <li class=playinfodetails>age 28 (born 22 april ,1987)</li>
                                    <li class=playerInfo><span>STRIKER</span> <span><i class="fa fa-heart"></i>45</span>
                                    </li>
                        ...
                        <li><a href="#">
                            <div class=playerFig>
                                <div class=playerpic>
                                    <div style=background:url(Assets/images/player/player05.jpg) class=bgimg></div>
                                </div>
                                <ul class="playerDetails clearfix">
                                    <li><span>Dominick Dumbleton</span> <span><img src=Assets/images/icons/tShirt.png
                                                                                   alt=image></span></li>
                                    <li class=playinfodetails>age 28 (born 22 april ,1987)</li>
    ...
    <section class=gallery>
        ...
        <div class=galleryWrapper>
            <div class=grid>
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery02.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery03.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery04.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery021.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery031.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/five.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/masonry/medium_01.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/gallery041.jpg alt=image>
                ...
                <div class=grid_item>
                    <div class=gallery_dtl><img src=Assets/images/gallery/masonry/medium_03.jpg alt=image>
            ...
            <div class=row><h2 class=heading>awa<span>rds</span></h2>
                ...
                <div class="wrapper-container clearfix"><a class="prv awards_prev"></a> <a class="nxt awards_next"></a>
                    <ul class="awards-wrap clearfix">
                        <li><a href=achivement_details.html><img src=Assets/images/awards/awards01.png alt=image>
                            <ul class=awards-info>
                                <li>uefa 2014</li>
                                <li>champion</li>
                            </ul>
                        </a></li>
                        <li><a href=achivement_details.html><img src=Assets/images/awards/awards02.png alt=image>
                            <ul class=awards-info>
                                <li>uefa 2014</li>
                                <li>champion</li>
                            </ul>
                        </a></li>
                        <li><a href=achivement_details.html><img src=Assets/images/awards/awards03.png alt=image>
                            <ul class=awards-info>
                                <li>uefa 2014</li>
                                <li>champion</li>
                            </ul>
                        </a></li>
                        <li><a href=#><img src=Assets/images/awards/awards04.png alt=image>
                            <ul class=awards-info>
                                <li>uefa 2014</li>
                                <li>champion</li>
                            </ul>
            ...
            <div class=row><h2 class=heading>TOP PRODUCTS & <span>merchandise</span></h2>
                ...
                <ul class=product_details>
                    <li><a href=#>
                        <div>
                            <div class=product-img
                                 style="background:url(Assets/images/product/product01.jpg) center no-repeat"></div>
                        </div>
                    ...
                    <li><a href=#>
                        <div>
                            <div class=product-img
                                 style="background:url(Assets/images/product/product02.jpg) center no-repeat"></div>
                        </div>
                        <ul class="oswald16 product_info">
                            <li class=detailsContainer><span>soccer jersey</span> <span><i
                                    class="fa fa-user"></i>360</span></li>
                    ...
                    <li><a href=#>
                        <div>
                            <div class=product-img
                                 style="background:url(Assets/images/product/product03.jpg) center no-repeat"></div>
                        </div>
                        <ul class="oswald16 product_info">
                            <li class=detailsContainer><span>soccer jersey</span> <span><i
                                    class="fa fa-user"></i>360</span></li>
                    ...
                    <li><a href=#>
                        <div>   
                            <div class=product-img
                                 style="background:url(Assets/images/product/product04.jpg) center no-repeat"></div>
                        </div>
                        <ul class="oswald16 product_info">
                            <li class=detailsContainer><span>soccer jersey</span> <span><i
                                    class="fa fa-user"></i>360</span></li>
